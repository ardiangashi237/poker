...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Badge'
        db.create_table('santiago_badge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('earned_filename', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('unearned_filename', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('alt_text', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('santiago', ['Badge'])


    def backwards(self, orm):
        # Deleting model 'Badge'
        db.delete_table('santiago_badge')
    ...
    models = {
        ...
        'santiago.badge': {
            ...
            'alt_text': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'earned_filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sequence': ('django.db.models.fields.IntegerField', [], {}),
            'timestamp': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'unearned_filename': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'santiago.buyin': {
        ...
        'santiago.userprofile': {
            ...
            'current_level_effective_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
