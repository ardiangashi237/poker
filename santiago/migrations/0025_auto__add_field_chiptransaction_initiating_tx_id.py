...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChipTransaction.initiating_tx_id'
        db.add_column('santiago_chiptransaction', 'initiating_tx_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChipTransaction.initiating_tx_id'
        db.delete_column('santiago_chiptransaction', 'initiating_tx_id')
