...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipLevel.daily_top_up_threshold'
        db.add_column('santiago_membershiplevel', 'daily_top_up_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipLevel.daily_top_up_threshold'
        db.delete_column('santiago_membershiplevel', 'daily_top_up_threshold')
