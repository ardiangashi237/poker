...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipLevel.signup_award'
        db.add_column('santiago_membershiplevel', 'signup_award',
                      self.gf('django.db.models.fields.IntegerField')(default=200),
                      keep_default=False)

        # Adding field 'MembershipLevel.monthly_award'
        db.add_column('santiago_membershiplevel', 'monthly_award',
                      self.gf('django.db.models.fields.IntegerField')(default=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipLevel.signup_award'
        db.delete_column('santiago_membershiplevel', 'signup_award')

        # Deleting field 'MembershipLevel.monthly_award'
        db.delete_column('santiago_membershiplevel', 'monthly_award')
