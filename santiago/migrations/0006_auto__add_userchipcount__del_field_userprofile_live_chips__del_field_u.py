...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserChipCount'
        db.create_table('santiago_userchipcount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('serial', self.gf('django.db.models.fields.IntegerField')()),
            ('real_chips', self.gf('django.db.models.fields.IntegerField')()),
            ('live_chips', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('santiago', ['UserChipCount'])
    ...
    def backwards(self, orm):
        # Deleting model 'UserChipCount'
        db.delete_table('santiago_userchipcount')
