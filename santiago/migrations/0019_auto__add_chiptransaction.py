...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChipTransaction'
        db.create_table('santiago_chiptransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('chips', self.gf('django.db.models.fields.IntegerField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('santiago', ['ChipTransaction'])


    def backwards(self, orm):
        # Deleting model 'ChipTransaction'
        db.delete_table('santiago_chiptransaction')
