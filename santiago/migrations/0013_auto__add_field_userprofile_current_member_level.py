...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_member_level'
        db.add_column('santiago_userprofile', 'current_member_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['santiago.MembershipLevel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_member_level'
        db.delete_column('santiago_userprofile', 'current_member_level_id')
