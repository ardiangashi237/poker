...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_level_effective_date'
        db.add_column('santiago_userprofile', 'current_level_effective_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_level_effective_date'
        db.delete_column('santiago_userprofile', 'current_level_effective_date')
