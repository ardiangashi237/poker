...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserMembershipLevelHistory'
        db.create_table('santiago_usermembershiplevelhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['santiago.MembershipLevel'])),
        ...
        db.send_create_signal('santiago', ['UserMembershipLevelHistory'])


    def backwards(self, orm):
        # Deleting model 'UserMembershipLevelHistory'
        db.delete_table('santiago_usermembershiplevelhistory')
