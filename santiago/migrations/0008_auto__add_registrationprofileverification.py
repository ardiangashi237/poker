...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegistrationProfileVerification'
        db.create_table('santiago_registrationprofileverification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registration_profile', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['santiago.RegistrationProfile'], unique=True)),
        ...
        db.send_create_signal('santiago', ['RegistrationProfileVerification'])


    def backwards(self, orm):
        # Deleting model 'RegistrationProfileVerification'
        db.delete_table('santiago_registrationprofileverification')
    ...
    models = {
        ...
        'santiago.registrationprofileverification': {
            ...
            'client_ip': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'registration_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['santiago.RegistrationProfile']", 'unique': 'True'}),
