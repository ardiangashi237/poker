...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserMembershipLevelHistory.end_date'
        db.alter_column('santiago_usermembershiplevelhistory', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserMembershipLevelHistory.end_date'
        db.alter_column('santiago_usermembershiplevelhistory', 'end_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 1, 0, 0)))
