...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipLevel.allow_chip_purchases'
        db.add_column('santiago_membershiplevel', 'allow_chip_purchases',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipLevel.allow_chip_purchases'
        db.delete_column('santiago_membershiplevel', 'allow_chip_purchases')
