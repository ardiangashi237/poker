...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipLevel.ad_required_for_top_up'
        db.add_column('santiago_membershiplevel', 'ad_required_for_top_up',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipLevel.ad_required_for_top_up'
        db.delete_column('santiago_membershiplevel', 'ad_required_for_top_up')
