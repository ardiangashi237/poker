...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('santiago_chiptransaction', 'chips', 'real_chips')
        db.add_column('santiago_chiptransaction', 'bank_chips', models.IntegerField())

    def backwards(self, orm):
        db.rename_column('santiago_chiptransaction', 'real_chips', 'chips')
        db.delete_column('santiago_chiptransaction', 'bank_chips')
