...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('santiago_faqcategory')

        # Deleting model 'Faq'
        db.delete_table('santiago_faq')


    def backwards(self, orm):
        # Adding model 'FaqCategory'
        db.create_table('santiago_faqcategory', (
            ('sequence', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('santiago', ['FaqCategory'])

        # Adding model 'Faq'
        db.create_table('santiago_faq', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['santiago.FaqCategory'])),
            ('sequence', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('answer', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('santiago', ['Faq'])
