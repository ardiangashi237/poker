...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistrationProfile.joined_via_fb'
        db.add_column('santiago_registrationprofile', 'joined_via_fb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistrationProfile.joined_via_fb'
        db.delete_column('santiago_registrationprofile', 'joined_via_fb')
