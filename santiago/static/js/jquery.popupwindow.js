jQuery.fn.popupwindow = function(p)
{
  ...
  var profiles = p || {};
  var prefix = parseInt(Math.random()*99999) + '_';
  ...
  return this.each(function(index){
    ...
    jQuery(this).bind("click", function(){
      var name = settings.createnew ? "PopUpWindow" + index : "PopUpWindow";
		/*debug*/
		//$('div#debug').append('<P> name begin is'+name+'<P>');
      var thisObject = this;

		/*debug*/
		//$('div#debug').append('<P> target is'+ jQuery(this).attr('target') +'<P>');
      ...
      if ( typeof thisObject._window == 'undefined' || thisObject._window.closed ) {
  		/*debug*/
  		//$('div#debug').append('<P> name is'+name+'<P>');
  		//$('div#debug').append('<P> index is'+index+'<P>');
