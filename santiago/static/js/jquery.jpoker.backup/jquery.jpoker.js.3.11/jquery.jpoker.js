...
//                 element.html(jpoker.plugins.table.templates.sound.supplant({ sound: _("<span>Sound Off</span>") }));
    ...
    jpoker.plugins.table.templates = {
        ...
        powered_by: '',
        chat: '<div class=\'jpoker_chat_input\'><input value=\'chat here\' type=\'text\' width=\'100%\' maxlength=\'128\' /><div class=\'jpoker_chat_enter_button\'></div></div><div class=\'jpoker_chat_history_player_box\'><div class=\'jpoker_chat_history_player_heading\'>{chat_history_player_label}</div><div class=\'jpoker_chat_history_player\'></div></div><div class=\'jpoker_chat_history_dealer_box\'><div class=\'jpoker_chat_history_dealer_heading\'>{chat_history_dealer_label}</div><div class=\'jpoker_chat_history_dealer\'></div></div>',
    ...
    jpoker.plugins.playerSelf = {
        create: function(table, packet, id) {
            ...
            var chat = function() {
                ...
                if(server) {
                    ...
                    if (message && message != '' && message != 'chat here') {
                    ...
                    input.attr('value', '');
					if (message == '' || message == 'chat here')
					{
						input.attr('value', 'chat here');
					}
                }
            };
        ...
        rebuy: function(url, game_id, serial, id) {
            ...
            if (table.buyIn.bankroll < table_buyin) {
                ...
                if (regular_chips < table_buyin) {
                    lc_buyin = table_buyin - regular_chips;
                    message = "You are about to use " + regular_chips + " RCs and " + lc_buyin + " LCs to buy into this game. You can always buy more RCs via your Member Account page.";
                }
            }
            ...
            if (in_rathole_scenario) {
                ...
                var rc_buyin = rathole_data.real_chips;
                lc_buyin = rathole_data.live_chips;
            }
            else {
                var min = limits[0];
                var current = limits[1];
                var max = limits[2];
                // regular_chips stores player's total RC count
                // current is displayed, unless player is dipping into LCs
                var rc_buyin = Math.min(current, regular_chips);
            }
        ...
        handOdds: function(player, odds, id) {
			...
			$('.slidechart').find(".background1").css('width',  '' + probability + '%');
			...
			$('.slidechart').find(".background2").css('width',  '' + probability + '%');
			...
			$('.slidechart').find(".background3").css('width',  '' + probability + '%');
			...
			$('.slidechart').find(".background4").css('width',  '' + probability + '%');
...
//            $('.jpoker_timebank_value', timebank_element).html(timebank_remainder);
            ...
            function timer() {
				...
				$('.jpoker_ptable_timebank_redbar').css('background-position', '0 ' + (45-timebank_remainder) * 107 / 45 + '');
            }
        },
        ...
        templates: {
            rebuy: '<div style=\'float: left; font-size: 11px; font-weight: bold; position: relative; left: 42px; \' class=\'jpoker_rebuy_regular\'>REGULAR CHIPS</div>' + 
				...
				'<div style=\'border-bottom-right-radius: 6px; border-bottom-left-radius: 6px; border-top-right-radius: 6px; border-top-left-radius: 6px; display: none; \' class=\'ui-slider-1 ui-slider-gradient\'><div class=\'ui-slider-handle\' style=\'border-radius: 0; height: 1.8em; width: 1.8em; top: -0.35em; \' ></div></div>' + 
