...
//                $('body').append('<div style="min-width: 300px; min-height: 300px;" id=\'jpokerRebuy\' class=\'jpoker_jquery_ui\' title=\'' + _("Add chips") + '\' />');
        ...
        handStart: function(player, id) {
			...
			$('.slidechart').find("tr:nth-child(1) td").css('background-size',  '0% 100%');
			$('.slidechart').find("tr:nth-child(2) td").css('background-size',  '0% 100%');
			$('.slidechart').find("tr:nth-child(3) td").css('background-size',  '0% 100%');
			$('.slidechart').find("tr:nth-child(4) td").css('background-size',  '0% 100%');
        },
        ...
        handOdds: function(player, odds, id) {
			...
			$('.slidechart').find("tr:nth-child(1) td").css('background-size',  '' + probability + '% 100%');
			...
			$('.slidechart').find("tr:nth-child(2) td").css('background-size',  '' + probability + '% 100%');
			...
			$('.slidechart').find("tr:nth-child(3) td").css('background-size',  '' + probability + '% 100%');
			...
			$('.slidechart').find("tr:nth-child(4) td").css('background-size',  '' + probability + '% 100%');
...
//            $('.jpoker_timebank_value', timebank_element).html(timebank_remainder);
                ...
                if(betLimit.max > betLimit.min) {
                    ...
                    var slider_raise_update = function() {
                      ...
                      if (isNaN(value)) {
                          ...
                          $('.jpoker_raise_input', raise_input).val(value);
                      } else {
        ...
        templates: {
            rebuy: '<div style=\'float: left; font-size: 11px; font-weight: bold; position: relative; left: 42px; \' class=\'jpoker_rebuy_regular\'>REGULAR CHIPS</div>' + 
				...
				'<div style=\'clear: both; float: left; width: 113px; height: 23px; left: 36px; position: relative; margin-top: 10px; \' class=\'jpoker_rebuy_regular_btn\'><span style=\'font-size: 12px; font-weight: bold; margin-top: 4px; display: block; text-align: center;\'>{current}</span></div>' + 
	...
	jpoker.plugins.handmaker = {
		templates : {
			handmakerbg: '<div style=\'background-color: white; width: 117px; height: 88px; margin: 18px auto;\' >' + 
				'<div style=\'width: 69%; height: 100%; float: left; border-right: 1px solid #444444\'></div><div class=\'slidechart\' style=\'width: 30%; height: 100%; float: left;\'><table style=\'width: 100%; height: 100%;\'><tr style=\'width: 35px; height: 17px\'><td style=\'background-size: 0 0;\'></td></tr><tr style=\'width: 35px; height: 17px\'><td style=\'background-size: 0 0;\'></td></tr><tr style=\'width: 35px; height: 17px\'><td style=\'background-size: 0 0;\'></td></tr><tr style=\'width: 35px; height: 17px\'><td style=\'background-size: 0 0;\'></td></tr></table></div></div>'
        ...
        update: function(chips, id) {
            ...
            if(chips > 0) {
				if (element.hasClass('jpoker_bet'))
				{
					...
					nCount = nCount + 1;
					nTags = nTags + '<div style=\'padding-top: 14px\' class=\'jpoker_chips_amount jpoker_chips_' + nCount + '_position\'></div>';
					element.html(nTags); 
					element.show();
