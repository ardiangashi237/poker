        ...
        update: function(chips, id) {
            ...
            if(chips > 0) {
				if (element.hasClass('jpoker_bet'))
				{
					...
					nCount = nCount + 1;
					nTags = nTags + '<div style=\'padding-top: 14px; padding-left: 7px;\' class=\'jpoker_chips_amount jpoker_chips_' + nCount + '_position\'></div>';
					element.html(nTags); 
					element.show();
