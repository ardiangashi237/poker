...
//                 element.html(jpoker.plugins.table.templates.sound.supplant({ sound: _("<span>Sound Off</span>") }));
    ...
    jpoker.plugins.playerSelf = {
        create: function(table, packet, id) {
			...
			var avatar_element = $('#player_seat' + player.seat  + '_avatar' + id);
			avatar_element.unbind('click');
			...
			$('.jpoker_ptable_lobby').click(function() {
				document.location = 'http://ec2-54-242-183-43.compute-1.amazonaws.com/tables/lobby/';
			});
        ...
        handOdds: function(player, odds, id) {
			...
			probability = 33 * probability / 100.0;
			$('.slidechart').find(".background1").css('width',  '' + probability + 'px');
			...
			probability = 33 * probability / 100.0;
			$('.slidechart').find(".background2").css('width',  '' + probability + 'px');
			...
			probability = 33 * probability / 100.0;
			$('.slidechart').find(".background3").css('width',  '' + probability + 'px');
			...
			probability = 33 * probability / 100.0;
			$('.slidechart').find(".background4").css('width',  '' + probability + 'px');
