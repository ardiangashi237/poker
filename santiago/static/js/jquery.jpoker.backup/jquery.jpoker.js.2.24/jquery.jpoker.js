        ...
        update: function(chips, id) {
            ...
            if(chips > 0) {
				if (element.hasClass('jpoker_bet'))
				{
					...
					} else if (element.hasClass('jpoker_ptable_player_seat1_bet') || element.hasClass('jpoker_ptable_player_seat2_bet') || element.hasClass('jpoker_ptable_player_seat3_bet') || element.hasClass('jpoker_ptable_player_seat6_bet'))
					{
						if (nCount % 2 == 0)
						{
							amountTag = '<div style=\'padding-top: 14px; \' class=\'jpoker_chips_amount jpoker_chips_' + nCount + '_position\'><span style=\'padding-left: 10px; float: left;\'></span></div>';							
					...
					} else if (element.hasClass('jpoker_ptable_player_seat7_bet'))
					{
						if (nCount % 2 == 0)
						{
							amountTag = '<div style=\'padding-top: 14px; \' class=\'jpoker_chips_amount jpoker_chips_' + nCount + '_position\'><span style=\'padding-right: 10px; float: right;\'></span></div>';							
				...
				{	
					...
					nCount = nCount + 1;
					nTags = nTags + '<div style=\'padding-top: 14px; position: absolute; top: -89px; left: 114px; height: 15px; width: 86px; text-align: center; \' class=\'jpoker_chips_amount jpoker_chips_' + nCount + '_position\'><span></span></div>';
					element.html(nTags); 
					element.show();
