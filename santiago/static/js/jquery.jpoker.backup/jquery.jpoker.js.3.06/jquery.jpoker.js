...
//            $('.jpoker_timebank_value', timebank_element).html(timebank_remainder);
        ...
        templates: {
            ...
            auto_action: '<div style=\'width: 100px; height: 20px;\'><div class=\'jpoker_auto_check_fold jpoker_auto_action\' style=\'left: -40px; position: relative;\'><label for=\'auto_check_fold{id}\' style=\'font-size: 13px; width: 66px;\'>{auto_check_fold_label}</label><input type=\'checkbox\' name=\'auto_check_fold\' id=\'auto_check_fold{id}\' /></div></div><div style=\'width: 80px; height: 20px;\'><div class=\'jpoker_auto_check jpoker_auto_action\' style=\'left: 61px; position: relative;\'><label for=\'auto_check{id}\' style=\'font-size: 13px; width: 33px;\'>{auto_check_label}</label><input type=\'checkbox\' name=\'auto_check\' id=\'auto_check{id}\' /></div></div><div style=\'width: 80px; height: 20px;\'><div class=\'jpoker_auto_call jpoker_auto_action\' style=\'left: -13px; position: relative; top: 40px; \'><label for=\'auto_call{id}\' style=\'width: 39px; font-size: 13px; \'>{auto_call_label} <span class=\'jpoker_call_amount\'></span></label><input type=\'checkbox\' name=\'auto_call\' id=\'auto_call{id}\' /></div></div><div style=\'width: 130px; height: 20px;\'><div class=\'jpoker_auto_check_call jpoker_auto_action\' style=\'left: -61px; position: relative; top: -20px; \'><label for=\'auto_check_call{id}\' style=\'font-size: 13px; width: 87px;\'>{auto_check_call_label}</label><input type=\'checkbox\' name=\'auto_check_call\' id=\'auto_check_call{id}\' /></div></div><div style=\'width: 80px; height: 20px;\'><div class=\'jpoker_auto_raise jpoker_auto_action\' style=\'left: 62px; position: relative; top: -20px; \'><label for=\'auto_raise{id}\' style=\'width: 32px; font-size: 13px; \'>{auto_raise_label}</label><input type=\'checkbox\' name=\'auto_raise\' id=\'auto_raise{id}\' /></div></div>',
