                    ...
                    if(server) {
                        ...
                        if (!isNaN(amount)) {
                            server.sendPacket({ 'type': packet_type,
                                        ...
                                        'game_id': table.id,
                                        'amount_lc': lc_buyin,
                                        'rathole_lc': amount - table.buyIn.min,
                                        'amount': amount - lc_buyin
                                }, 
                                function() {
...
//            $('.jpoker_timebank_value', timebank_element).html(timebank_remainder);
        ...
        inPosition: function(player, id) {
            ...
            var send = function(what) {
				...
				if (what == 'Fold')
				{
					$('#seat' + player.seat + id + ' .jpoker_name').hover(function(){
...
//				'<div class=\'ui-dialog-buttonpane\'><button class=\'jpoker_rebuy_action\'></button><button class=\'jpoker_buy_chips\'></button></div>' + 
            ...
            auto_action: '<div style=\'width: 100px; height: 20px;\'><div class=\'jpoker_auto_check_fold jpoker_auto_action\' style=\'left: -30px; position: relative;\'><label for=\'auto_check_fold{id}\' style=\'font-size: 13px; width: 66px;\'>{auto_check_fold_label}</label><input type=\'checkbox\' name=\'auto_check_fold\' id=\'auto_check_fold{id}\' /></div></div><div style=\'width: 80px; height: 20px;\'><div class=\'jpoker_auto_check jpoker_auto_action\' style=\'left: 52px; position: relative;\'><label for=\'auto_check{id}\' style=\'font-size: 13px; width: 33px;\'>{auto_check_label}</label><input type=\'checkbox\' name=\'auto_check\' id=\'auto_check{id}\' /></div></div><div style=\'width: 80px; height: 20px;\'><div class=\'jpoker_auto_call jpoker_auto_action\' style=\'left: -3px; position: relative; top: 40px; \'><label for=\'auto_call{id}\' style=\'width: 39px; font-size: 13px; \'>{auto_call_label} <span class=\'jpoker_call_amount\'></span></label><input type=\'checkbox\' name=\'auto_call\' id=\'auto_call{id}\' /></div></div><div style=\'width: 130px; height: 20px;\'><div class=\'jpoker_auto_check_call jpoker_auto_action\' style=\'left: -51px; position: relative; top: -20px; \'><label for=\'auto_check_call{id}\' style=\'font-size: 13px; width: 87px;\'>{auto_check_call_label}</label><input type=\'checkbox\' name=\'auto_check_call\' id=\'auto_check_call{id}\' /></div></div><div style=\'width: 80px; height: 20px;\'><div class=\'jpoker_auto_raise jpoker_auto_action\' style=\'left: 53px; position: relative; top: -20px; \'><label for=\'auto_raise{id}\' style=\'width: 32px; font-size: 13px; \'>{auto_raise_label}</label><input type=\'checkbox\' name=\'auto_raise\' id=\'auto_raise{id}\' /></div></div>',
...
//J         timebank: '<span class=\'jpoker_timebank_label\'>{label}</span> <span class=\'jpoker_timebank_value\'></span>',
            ...
            rebuy_button: '<div class=\'jpoker_rebuy\'><a style=\'border: medium none; width: 80px;\' href=\'javascript://\'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>',
...
//            button: '<div class=\'jpoker_options\'><a href=\'javascript://\'>{options_label}</a></div>',
            button: '<div class=\'jpoker_options\'><a style=\'border: medium none; width: 80px;\' href=\'javascript://\'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>',
        ...
        update: function(chips, id) {
            ...
            if(chips > 0) {
				if (element.hasClass('jpoker_bet'))
				{
					...
					} else if (element.hasClass('jpoker_ptable_player_seat1_bet') || element.hasClass('jpoker_ptable_player_seat2_bet') || element.hasClass('jpoker_ptable_player_seat3_bet'))
					{
						if (nCount % 2 == 0)
						{
							amountTag = '<div style=\'padding-top: 14px; \' class=\'jpoker_chips_amount jpoker_chips_' + nCount + '_position\'><span style=\'padding-left: 10px; float: left;\'></span></div>';							
					...
					} else if (element.hasClass('jpoker_ptable_player_seat6_bet') || element.hasClass('jpoker_ptable_player_seat7_bet'))
					{
						if (nCount % 2 == 0)
						{
							amountTag = '<div style=\'padding-top: 14px; \' class=\'jpoker_chips_amount jpoker_chips_' + nCount + '_position\'><span style=\'padding-right: 10px; float: right;\'></span></div>';							
