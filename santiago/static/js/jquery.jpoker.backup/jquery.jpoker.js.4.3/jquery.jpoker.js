...
//                 element.html(jpoker.plugins.table.templates.sound.supplant({ sound: _("<span>Sound Off</span>") }));
	...
	jpoker.plugins.table.timeBank = function(element, timebank_remainder) {
		...
		timeBankIntervalId = setInterval(timer, 1000);
            ...
            case 'PacketPokerTimeoutNotice':
				...
				for(var seat = 0; seat < table.seats.length; seat++) {
					...
					if(in_position && in_position.sit_out === false && in_position.seat == seat) {
						...
						//alert(seat);
						//$('.jpoker_timeout_progress', timeout_element).css('width',  66.5 * packet.timebank_remainder / 45.0 + 'px');
						clearInterval(timeBankIntervalId);
            ...
            case 'PacketPokerChat':
                ...
                if(filtered_packet !== null) {
					...
					for(var line = 0; line < lines.length; line++) {
						...
						message = message.replace("0.", "0");message = message.replace("1.", "1");message = message.replace("2.", "2");message = message.replace("3.", "3");message = message.replace("4.", "4");
						message = message.replace("5.", "5");message = message.replace("6.", "6");message = message.replace("7.", "7");message = message.replace("8.", "8");message = message.replace("9.", "9");
    ...
    jpoker.plugins.playerSelf = {
        create: function(table, packet, id) {
            ...
            rebuy.click(function() {
                    ...
                    if(server && server.loggedIn()) {
                        ...
                        if(element) {
                            element.dialog('open');
                            // SCL commenting out next line as it seems unnecessary for buyins
                            //  However I'm afraid it might break rebuys
                            //server.getUserInfo();
                        }
                    }
                });
        ...
        rebuy: function(url, game_id, serial, id) {
            ...
            if ( ! in_buyin_scenario ) { // this is a rebuy
                ...
                // furthermore, in rebuy scenario, regular_chips seems to be set to pre-buyin amount, so subtract table buyin
                // SCL: this next section appears to be a hack. What about multiple rebuys? What about when player has zero RCs?
                //          We need to get refreshed player info when player first activates rebuy dialog.
                regular_chips = Math.max(regular_chips-table.buyIn.min, 0);
            }
            ...
            if (table.buyIn.bankroll < table_buyin) {
                jpoker.dialog("sorry, you don't have enough chips");
                return false;
            }
                ...
                if (in_rathole_scenario && (live_chips <  rathole_data.live_chips)) { 
                    jpoker.dialog("Sorry, you may not play at this table right now, as you have only " + live_chips + " available LCs.<br/><br/>" + rathole_data.message);
                    return false;
                }
                ...
                if (regular_chips < table_buyin) { // dipping into live chips
                    ...
                    message = "You are about to use " + rc_buyin + " RCs and " + lc_buyin + " LCs to buy into this game. You can always buy more RCs by clicking the Buy Chips button.";
                }
...
//            $('.jpoker_timebank_value', timebank_element).html(timebank_remainder);
        ...
        templates: {
            rebuy: '<div style=\'float: left; font-size: 11px; font-weight: bold; position: relative; left: 42px; \' class=\'jpoker_rebuy_regular\'>REGULAR CHIPS</div>' + 
				...
				'<div class=\'ui-dialog-buttonpane\'><button class=\'jpoker_rebuy_action\'> {label} </button><button class=\'jpoker_buy_chips\' onclick=\'javascript:window.open(\"/tables/reload/\")\'>&nbsp;</button></div>' + 
            ...
            auto_action: '<div class=\'jpoker_auto_check_fold jpoker_auto_action\' style=\'position: relative;text-align:right;margin-right:86px;\'><label for=\'auto_check_fold{id}\' style=\'font-size: 13px; width: 66px;\'>{auto_check_fold_label}</label><input type=\'checkbox\' name=\'auto_check_fold\' id=\'auto_check_fold{id}\' /></div><div style=\'height:20px;text-align:right;\'><div class=\'jpoker_auto_check jpoker_auto_action\' style=\' position: relative;\'><label for=\'auto_check{id}\' style=\'font-size: 13px; width: 33px;\'>{auto_check_label}</label><input type=\'checkbox\' name=\'auto_check\' id=\'auto_check{id}\' /></div></div><div class=\'jpoker_auto_check_call jpoker_auto_action\' style=\' position: relative; text-align:right;margin-right:86px;\'><label for=\'auto_check_call{id}\' style=\'font-size: 13px; width: 150px;\'>{auto_check_call_label}</label><input type=\'checkbox\' name=\'auto_check_call\' id=\'auto_check_call{id}\' /></div><div class=\'jpoker_auto_raise jpoker_auto_action\' style=\'position: relative;text-align:right; \'><label for=\'auto_raise{id}\' style=\'width: 32px; font-size: 13px; \'>{auto_raise_label}</label><input type=\'checkbox\' name=\'auto_raise\' id=\'auto_raise{id}\' /></div><div class=\'jpoker_auto_call jpoker_auto_action\' style=\' position: relative; text-align:right;margin-right:86px;\'><label for=\'auto_call{id}\' style=\'width: 39px; font-size: 13px; \'>{auto_call_label} <span class=\'jpoker_call_amount\'></span></label><input type=\'checkbox\' name=\'auto_call\' id=\'auto_call{id}\' /></div>',
	...
	jpoker.plugins.handmaker = {
		templates : {
			handmakerbg: '<div style=\'background-color: white; width: 119px; height: 88px; margin: 18px auto;\' >' + 
				'<div style=\'width: 70%; height: 100%; float: left; border-right: 1px solid #444444\'></div><div class=\'slidechart\' style=\'width: 29%; height: 100%; float: left;\'><div style=\'width: 100%; height: 100%;\'><div style=\'width: 35px; height: 17px; margin-left: 0px; margin-top: 3px; \'><div class=\'background1\' style=\'width: 0%; height: 100%;\'></div></div><div style=\'width: 35px; height: 17px; margin-left: 0px; margin-top: 4px; \'><div class=\'background2\' style=\'width: 0%; height: 100%;\'></div></div><div style=\'width: 35px; height: 17px; margin-left: 0px; margin-top: 4px;\'><div class=\'background3\' style=\'width: 0%; height: 100%;\'></div></div><div style=\'width: 35px; height: 17px; margin-left: 0px; margin-top: 4px;\'><div class=\'background4\' style=\'width: 0%; height: 100%;\'></div></div></div></div></div>'
