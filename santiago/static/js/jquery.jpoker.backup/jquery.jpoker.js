...
//                 element.html(jpoker.plugins.table.templates.sound.supplant({ sound: _("<span>Sound Off</span>") }));
    ...
    jpoker.plugins.player = {
        ...
        handOdds: function(player, odds, id) {
            if(jpoker.getServer(player.url).serial == player.serial) {
                jpoker.plugins.playerSelf.handOdds(player, odds, id);
            }
        },
    ...
    jpoker.plugins.playerSelf = {
        ...
        handStart: function(player, id) {
			...
			$('.slidechart').find(".background1").css('width',  '0%');
			$('.slidechart').find(".background2").css('width',  '0%');
			$('.slidechart').find(".background3").css('width',  '0%');
			$('.slidechart').find(".background4").css('width',  '0%');
        ...
        handOdds: function(player, odds, id) {
			...
			$('.jpoker_hand_odds_value').find("td:nth-child(2)").css('width','20px');
			...
			probability = $('.jpoker_hand_odds_value').find("tr:nth-child(2) td:nth-child(2)").text().substring(0, $('.jpoker_hand_odds_value').find("tr:nth-child(2) td:nth-child(2)").text().length-1);
			barwidth = max_barwidth * (9 / 100);
			$('.slidechart').find(".background1").css('width',  barwidth + 'px');
			//$('.slidechart').find(".background1").hide();
			//$('.slidechart').find(".background1").show();

			probability = $('.jpoker_hand_odds_value').find("tr:nth-child(3) td:nth-child(2)").text().substring(0, $('.jpoker_hand_odds_value').find("tr:nth-child(3) td:nth-child(2)").text().length-1);
			barwidth = max_barwidth * (19 / 100);
			$('.slidechart').find(".background2").css('width',  barwidth + 'px');
			//$('.slidechart').find(".background2").hide();
			//$('.slidechart').find(".background2").show();
			
			probability = $('.jpoker_hand_odds_value').find("tr:nth-child(4) td:nth-child(2)").text().substring(0, $('.jpoker_hand_odds_value').find("tr:nth-child(4) td:nth-child(2)").text().length-1);
			barwidth = max_barwidth * (4 / 100);
			$('.slidechart').find(".background3").css('width',  barwidth + 'px');
			//$('.slidechart').find(".background3").hide();
			//$('.slidechart').find(".background3").show();

			probability = $('.jpoker_hand_odds_value').find("tr:nth-child(5) td:nth-child(2)").text().substring(0, $('.jpoker_hand_odds_value').find("tr:nth-child(5) td:nth-child(2)").text().length-1);
			barwidth = max_barwidth * (100 / 100);
			$('.slidechart').find(".background4").css('width',  barwidth + 'px');
			//$('.slidechart').find(".background4").hide();
			//$('.slidechart').find(".background4").show();
...
//            button: '<div class=\'jpoker_options\'><a href=\'javascript://\'>{options_label}</a></div>',
	...
	jpoker.plugins.handmaker = {
		templates : {
			handmakerbg: '<div style=\'background-color: white; width: 117px; height: 88px; margin: 18px auto;\' >' + 
				'<div style=\'width: 69%; height: 100%; float: left; border-right: 1px solid #444444\'></div><div class=\'slidechart\' style=\'width: 30%; height: 100%; float: left;\'><div style=\'width: 100%; height: 100%;\'><div style=\'width: 33px; height: 17px; margin-left: 1px; margin-top: 3px; \'><div class=\'background1\' style=\'width: 0%; height: 100%;\'></div></div><div style=\'width: 33px; height: 17px; margin-left: 1px; margin-top: 4px; \'><div class=\'background2\' style=\'width: 0%; height: 100%;\'></div></div><div style=\'width: 33px; height: 17px; margin-left: 1px; margin-top: 4px;\'><div class=\'background3\' style=\'width: 0%; height: 100%;\'></div></div><div style=\'width: 33px; height: 17px; margin-left: 1px; margin-top: 4px;\'><div class=\'background4\' style=\'width: 0%; height: 100%;\'></div></div></div></div></div>'
