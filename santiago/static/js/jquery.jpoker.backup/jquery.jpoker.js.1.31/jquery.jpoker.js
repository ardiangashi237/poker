...
//                $('body').append('<div style="min-width: 300px; min-height: 300px;" id=\'jpokerRebuy\' class=\'jpoker_jquery_ui\' title=\'' + _("Add chips") + '\' />');
        ...
        templates: {
            ...
            hand_odds: '<span class=\'jpoker_hand_odds_label\'>{label}</span> <span class=\'jpoker_hand_odds_value\'></span>',
            timebank: '<span class=\'jpoker_timebank_label\'>{label}</span> <span class=\'jpoker_timebank_value\'></span>',
	...
	jpoker.plugins.handmaker = {
		templates : {
			handmakerbg: '<div style=\'background-color: white; width: 117px; height: 88px; margin: 18px auto;\' >' + 
				'<div style=\'width: 70%; height: 100%; border-right: 1px solid #444444\'>' + 
