/*
	The Dynarch date time picker, now as a jQuery plugin. 
	jQuery container items are expected to be an input field.
	...
	Goals:
		...
		Move any global variables
		remove browser specific hacks
		Date parser: native impl? 
	
	Usage pattern: 
		jQuery( "inputField(s)" ).dynDateTime( {optName: optValue} );
